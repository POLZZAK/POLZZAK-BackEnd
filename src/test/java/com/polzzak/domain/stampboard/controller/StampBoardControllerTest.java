		...
		mockMvc.perform(
			...
			.andDo(document("stamp/board-get-success",
				...
				responseFields(
					...
					fieldWithPath("data.kid.id").description("아이 ID"),
					fieldWithPath("data.kid.nickname").description("아이 닉네임"),
					fieldWithPath("data.kid.profileUrl").description("아이 프로필"),
					fieldWithPath("data.guardian.id").description("아이 ID"),
					fieldWithPath("data.guardian.nickname").description("아이 닉네임"),
					fieldWithPath("data.guardian.profileUrl").description("아이 프로필"),
					...
					fieldWithPath("data.guardianMemberType.memberTypeDetailId").description("보호자 멤버 타입 ID"),
					fieldWithPath("data.guardianMemberType.detail").description("보호자 멤버 타입 상세"),
